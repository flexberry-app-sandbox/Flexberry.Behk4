...
namespace IIS.DestkijjSad
{
    ...
    [View("ПитанияE", new string[] {
            ...
            "Наименования as \'Наименование блюда\'",
    ...
    public class Питания : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.DestkijjSad.Питание fВидПитания;
        
        private IIS.DestkijjSad.DetailArrayOfСоставБлюда fСоставБлюда;
        ...
        public virtual IIS.DestkijjSad.Питание ВидПитания
        {
            get
            {
                ...
                IIS.DestkijjSad.Питание result = this.fВидПитания;
        ...
        /// Наименования.
        /// </summary>
        // *** Start programmer edit section *** (Питания.Наименования CustomAttributes)

        // *** End programmer edit section *** (Питания.Наименования CustomAttributes)
        [StrLen(255)]
        public virtual string Наименования
        {
            get
            {
                // *** Start programmer edit section *** (Питания.Наименования Get start)

                // *** End programmer edit section *** (Питания.Наименования Get start)
                string result = this.fНаименования;
                // *** Start programmer edit section *** (Питания.Наименования Get end)

                // *** End programmer edit section *** (Питания.Наименования Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Питания.Наименования Set start)

                // *** End programmer edit section *** (Питания.Наименования Set start)
                this.fНаименования = value;
                // *** Start programmer edit section *** (Питания.Наименования Set end)

                // *** End programmer edit section *** (Питания.Наименования Set end)
            }
        }
        ...
        public virtual IIS.DestkijjSad.DetailArrayOfСоставБлюда СоставБлюда
        {
            get
            {
                ...
                {
                    this.fСоставБлюда = new IIS.DestkijjSad.DetailArrayOfСоставБлюда(this);
                }
                IIS.DestkijjSad.DetailArrayOfСоставБлюда result = this.fСоставБлюда;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПитанияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПитанияE", typeof(IIS.DestkijjSad.Питания));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПитанияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПитанияL", typeof(IIS.DestkijjSad.Питания));
                }
            }
        }
    }
