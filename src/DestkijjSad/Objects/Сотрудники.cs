...
namespace IIS.DestkijjSad
{
    ...
    public class Сотрудники : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.DestkijjSad.Полы fПол;
        
        private System.DateTime fДатаРождения;
        
        private IIS.DestkijjSad.Должности fДолжности;
        ...
        public virtual IIS.DestkijjSad.Полы Пол
        {
            get
            {
                ...
                IIS.DestkijjSad.Полы result = this.fПол;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.DestkijjSad.Должности Должности
        {
            get
            {
                ...
                IIS.DestkijjSad.Должности result = this.fДолжности;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиE", typeof(IIS.DestkijjSad.Сотрудники));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиL", typeof(IIS.DestkijjSad.Сотрудники));
                }
            }
        }
    }
