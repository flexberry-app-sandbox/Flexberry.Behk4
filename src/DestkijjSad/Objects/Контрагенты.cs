...
namespace IIS.DestkijjSad
{
    ...
    public class Контрагенты : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.DestkijjSad.Виды fВид;
        ...
        public virtual IIS.DestkijjSad.Виды Вид
        {
            get
            {
                ...
                IIS.DestkijjSad.Виды result = this.fВид;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонтрагентыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтрагентыE", typeof(IIS.DestkijjSad.Контрагенты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КонтрагентыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтрагентыL", typeof(IIS.DestkijjSad.Контрагенты));
                }
            }
        }
    }
