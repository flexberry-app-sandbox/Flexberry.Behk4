...
namespace IIS.Behk4
{
    ...
    public class Сотрудники : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Behk4.Полы fПол;
        
        private System.DateTime fДатаРождения;
        
        private IIS.Behk4.Должности fДолжности;
        ...
        public virtual IIS.Behk4.Полы Пол
        {
            get
            {
                ...
                IIS.Behk4.Полы result = this.fПол;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Behk4.Должности Должности
        {
            get
            {
                ...
                IIS.Behk4.Должности result = this.fДолжности;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиE", typeof(IIS.Behk4.Сотрудники));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиL", typeof(IIS.Behk4.Сотрудники));
                }
            }
        }
    }
