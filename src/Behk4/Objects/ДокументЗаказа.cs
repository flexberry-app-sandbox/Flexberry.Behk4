...
namespace IIS.Behk4
{
    ...
    public class ДокументЗаказа : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Behk4.Контрагенты fКонтрагенты;
        
        private IIS.Behk4.DetailArrayOfЗапись fЗапись;
        ...
        [PropertyStorage(new string[] {
                "Контрагенты"})]
        [NotNull()]
        public virtual IIS.Behk4.Контрагенты Контрагенты
        {
            get
            {
                ...
                IIS.Behk4.Контрагенты result = this.fКонтрагенты;
        ...
        public virtual IIS.Behk4.DetailArrayOfЗапись Запись
        {
            get
            {
                ...
                {
                    this.fЗапись = new IIS.Behk4.DetailArrayOfЗапись(this);
                }
                IIS.Behk4.DetailArrayOfЗапись result = this.fЗапись;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокументЗаказаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокументЗаказаE", typeof(IIS.Behk4.ДокументЗаказа));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокументЗаказаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокументЗаказаL", typeof(IIS.Behk4.ДокументЗаказа));
                }
            }
        }
    }
